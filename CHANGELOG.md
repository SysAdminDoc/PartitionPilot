...
### Features
- Added Japanese (`ja`) interface translations covering every shipped resource key, and registered Japanese in the language selector so a `ja-JP` system language resolves to it.
